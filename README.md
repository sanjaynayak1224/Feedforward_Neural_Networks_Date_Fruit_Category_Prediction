...
An end-to-end deep learning project built to classify date fruit varieties based on their morphological, color, and texture features. Using a dataset of 898 date fruit samples, I designed, built, and evaluated a PyTorch-based Feedforward Neural Network (FNN) with model checkpointing. The final model achieves a **95.56% classification accuracy** on unseen test data—providing a reliable, lightweight model for automated agricultural sorting and food quality verification.

---

## 📊 Dataset Information

The dataset used in this project is the **Date Fruit Dataset**, originally collected by researchers *Murat Koklu* and *Yunus A. Sabanci* and hosted on the **UCI Machine Learning Repository**.
